...
from tasks.data_utils import build_classification_tokens_types_paddings_from_text ,build_tokens_types_paddings_from_text


class SVGLUEAbstractDataset(ABC, Dataset):
    ...
    def __getitem__(self, idx):
        ...
        ids, types, paddings = build_classification_tokens_types_paddings_from_text(
            raw_sample['text'], self.tokenizer, self.max_seq_length)
