...
#SBATCH -A swdl -N 2 -p interactive --job-name=sa-debug:gpt3_16A100 --ntasks-per-node=8

set -eux

DIR='/megatron_workspace'
DATETIME=`date +'date_%y-%m-%d_time_%H-%M-%S'`
CHECKPOINT_PATH=/lustre/fsw/swdl/zcharpy/sv_gpt3_ckpt/
...
srun -A swdl -l -N 2 --job-name=swdl-gpt3:sv2.7B_multinodes_16A100 --ntasks-per-node=8 \
