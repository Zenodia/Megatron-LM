...
#SBATCH -A swdl -N 2 -p interactive --job-name=sa-debug:gpt3_2N_16A100 --ntasks-per-node=8
...
srun -A swdl -N 2 --job-name=swdl-gpt3:sv174B_2nodes_16A100 --ntasks-per-node=8 \
