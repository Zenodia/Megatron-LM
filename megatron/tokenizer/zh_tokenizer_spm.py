...
class FullTokenizer(object):
    ...
    def __init__(self, vocab_file,merge_file):
        ...
        ## '[CLS]','[SEP]','[PAD]','[MASK]' is included by default in the .vocab file
        #self.vocab['[MASK]']=self.vocab['[MASK]']
        #self.vocab['[SEP]']=self.vocab['[SEP]']
        #self.vocab['[CLS]']=self.vocab['[CLS]']
        #self.vocab['[PAD]']=self.vocab['[PAD]']       
        self.inv_vocab = inverse_vocab(self.vocab)
